...
process costlier \Jose{What about {\tt osm} data set?}. Second, as we allowed {\tt psta} to utilize more
...
and for {\tt osm}, the consumption was 7 for {\tt libcds}\Jose{Review this value}, 194 for {\tt sdsl}, 331 for {\tt psta}.

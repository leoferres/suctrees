...
tree, we also introduce an algorithm to compute this parenthesis representation in $O(n/p)$ time.\Norbert{Why do we ignore the $\lg p$ term here but not before?}
\end{abstract}

\category{D.1.3}{Programming Techniques}{Concurrent Programming}[Parallel programming]
\category{E.1}{Data Structures}{Trees}

\terms{Algorithms, Performance\Norbert{I'm not sure ``performance'' is a useful general term.  Is it?}}

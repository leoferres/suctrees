...
\newcommand{\low}{\id{low}}
\newcommand{\up}{\id{up}}
\newcommand{\chk}{\id{chk}}
\newcommand{\threads}{\id{threads}}
\newcommand{\pr}{\id{par}}
\newcommand{\ct}{\id{ct}}
\newcommand{\asgn}{\mathrel{:=}}
\newcommand{\pasgn}{\mathrel{\mathnormal{+}{\mathnormal{=}}}}
\newcommand{\masgn}{\mathrel{\mathnormal{-}{\mathnormal{=}}}}
\newcommand{\eq}{=}
\newcommand{\st}{\id{st}}
\newcommand{\lvl}{\id{lvl}}
\newcommand{\parent}{\id{parent}}
\newcommand{\chld}{\id{child}}
